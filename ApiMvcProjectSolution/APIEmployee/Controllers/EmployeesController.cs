...
namespace APIEmployee.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public async Task<IActionResult> ShowOneEmployee(string searchString)
        {
            ...
            var employee = await _context.Employees.Where(e => e.FirstName.Contains(searchString) || e.LastName.Contains(searchString) || e.City.Contains(searchString) || e.Country.Contains(searchString)).ToListAsync();
            if (employee == null)
            {
